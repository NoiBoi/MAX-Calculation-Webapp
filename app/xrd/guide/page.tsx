...
export default function XrdGuidePage() {
  return <>
    <AppHeader activeSection="xrd" status="Workflow, methods, and scientific limits" title="XRD Guide" moreActions={<Link className="ui-button header-navigation-button" href="/xrd">XRD workspace</Link>} />
