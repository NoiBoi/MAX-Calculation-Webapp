...
MAXCalc supports 1366 x 768 through 3840 x 2160 at 100% browser zoom, including 1920 x 1080, 2560 x 1440, and 3440 x 1440 ultrawide layouts. Normal laptop and 1080p density remains the baseline. A clamped root size and semantic text, control, spacing, toolbar, panel, and maximum-width tokens increase progressively only when the viewport supplies both width and height.
