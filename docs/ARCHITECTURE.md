...
| XRD scientific service | `scientific-service`, `lib/xrd`, `app/api/xrd` | Isolated COD access, CIF parsing, processing, peak fitting, reference matching, lattice refinement, and versioned diffraction contracts |
