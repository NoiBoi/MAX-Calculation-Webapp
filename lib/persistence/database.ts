...
import type { StoredExperimentalXRDMeasurement, StoredProcessedXRDRepresentation, StoredRawXRDArtifact, StoredXRDPeakAnalysis, StoredXRDReferenceMatchingResult, StoredXRDLatticeRefinementResult } from "../xrd/persistence";
import type { XRDReference, XRDReferenceRevision } from "../xrd/references";
...
export class MaxStoichDatabase extends Dexie {
  ...
  xrdRawArtifacts!: Table<StoredRawXRDArtifact, string>;
  xrdMeasurements!: Table<StoredExperimentalXRDMeasurement, string>;
  xrdProcessedRepresentations!: Table<StoredProcessedXRDRepresentation, string>;
  xrdPeakAnalyses!: Table<StoredXRDPeakAnalysis, string>;
  xrdReferenceMatchingResults!: Table<StoredXRDReferenceMatchingResult, string>;
  xrdLatticeRefinementResults!: Table<StoredXRDLatticeRefinementResult, string>;
  xrdReferences!: Table<XRDReference, string>;
  xrdReferenceRevisions!: Table<XRDReferenceRevision, string>;
  ...
  constructor(name = "max-stoich-local") {
    ...
    this.version(13).stores({
      recipes: "&id,name,targetFormula,updatedAt,archived,currentRevisionNumber,validationStatus", recipeRevisions: "&id,[recipeId+revisionNumber],recipeId", snapshots: "&id,recipeId,recipeRevisionId,createdAt", routes: "&id,name,updatedAt,archived,validationStatus", routeRevisions: "&id,[routeId+revisionNumber],routeId", recentCalculations: "&snapshotId,lastOpenedAt,recipeId", recovery: "&id", migrations: "&id", comparisons: "&id,name,updatedAt,validationStatus", layouts: "&id,name,kind,isDefault,builtIn,updatedAt", radiusDatasets: "&id,&[datasetId+datasetVersion],datasetId,datasetVersion,localTrust,updatedAt", recipeNotes: "&id,recipeId,recipeRevisionId,category,updatedAt,archived,*tags", userSettings: "&id,updatedAt", cloudSyncRecords: "&id,ownerId,[ownerId+cloudState],[ownerId+recordType],recordId,cloudId", cloudSyncSessions: "&ownerId,lastSuccessfulSyncAt", cloudConflicts: "&id,ownerId,[ownerId+status],[ownerId+recordType],recordId", cloudQuarantine: "&id,ownerId,[ownerId+recordType],receivedAt", cloudDevices: "&ownerId,installationId", cloudSyncOutbox: "&id,ownerId,[ownerId+state],[ownerId+recordType],recordId,nextAttemptAt,idempotencyKey", cloudSyncLeases: "&ownerId,installationId,tabId,expiresAt", labCaches: "&id,name,role,updatedAt", labMemberships: "&id,labId,userId,[labId+status],role", labEntries: "&id,labId,[labId+visibilityStatus],updatedAt,syncSequence", labVersions: "&id,labId,entryId,[entryId+versionNumber],syncSequence", labPublicationNotes: "&id,labId,entryId,publicationVersionId,syncSequence", labAuditEvents: "&id,labId,eventType,occurredAt,syncSequence", labSyncSessions: "&id,ownerId,labId,lastSuccessfulSyncAt", emiProjects: "&id,name,updatedAt,createdAt", xrdRawArtifacts: "&artifactId,&sha256,importedAt", xrdMeasurements: "&id,rawArtifactId,rawArtifactSha256,importedAt,displayName",
    }).upgrade(async (transaction) => {
      await transaction.table("migrations").put({ schemaVersion: "13.0.0", id: "12-to-13-local-experimental-xrd", fromVersion: 12, toVersion: 13, appliedAt: new Date().toISOString(), status: "complete" });
    });
    this.version(14).stores({
      recipes: "&id,name,targetFormula,updatedAt,archived,currentRevisionNumber,validationStatus", recipeRevisions: "&id,[recipeId+revisionNumber],recipeId", snapshots: "&id,recipeId,recipeRevisionId,createdAt", routes: "&id,name,updatedAt,archived,validationStatus", routeRevisions: "&id,[routeId+revisionNumber],routeId", recentCalculations: "&snapshotId,lastOpenedAt,recipeId", recovery: "&id", migrations: "&id", comparisons: "&id,name,updatedAt,validationStatus", layouts: "&id,name,kind,isDefault,builtIn,updatedAt", radiusDatasets: "&id,&[datasetId+datasetVersion],datasetId,datasetVersion,localTrust,updatedAt", recipeNotes: "&id,recipeId,recipeRevisionId,category,updatedAt,archived,*tags", userSettings: "&id,updatedAt", cloudSyncRecords: "&id,ownerId,[ownerId+cloudState],[ownerId+recordType],recordId,cloudId", cloudSyncSessions: "&ownerId,lastSuccessfulSyncAt", cloudConflicts: "&id,ownerId,[ownerId+status],[ownerId+recordType],recordId", cloudQuarantine: "&id,ownerId,[ownerId+recordType],receivedAt", cloudDevices: "&ownerId,installationId", cloudSyncOutbox: "&id,ownerId,[ownerId+state],[ownerId+recordType],recordId,nextAttemptAt,idempotencyKey", cloudSyncLeases: "&ownerId,installationId,tabId,expiresAt", labCaches: "&id,name,role,updatedAt", labMemberships: "&id,labId,userId,[labId+status],role", labEntries: "&id,labId,[labId+visibilityStatus],updatedAt,syncSequence", labVersions: "&id,labId,entryId,[entryId+versionNumber],syncSequence", labPublicationNotes: "&id,labId,entryId,publicationVersionId,syncSequence", labAuditEvents: "&id,labId,eventType,occurredAt,syncSequence", labSyncSessions: "&id,ownerId,labId,lastSuccessfulSyncAt", emiProjects: "&id,name,updatedAt,createdAt", xrdRawArtifacts: "&artifactId,&sha256,importedAt", xrdMeasurements: "&id,rawArtifactId,rawArtifactSha256,importedAt,displayName", xrdProcessedRepresentations: "&id,parentMeasurementId,rawArtifactSha256,createdAt", xrdPeakAnalyses: "&id,parentProcessedRepresentationId,parentMeasurementId,rawArtifactSha256,createdAt",
    }).upgrade(async (transaction) => {
      await transaction.table("migrations").put({ schemaVersion: "14.0.0", id: "13-to-14-local-xrd-peak-analysis", fromVersion: 13, toVersion: 14, appliedAt: new Date().toISOString(), status: "complete" });
    });
    this.version(15).stores({
      recipes: "&id,name,targetFormula,updatedAt,archived,currentRevisionNumber,validationStatus", recipeRevisions: "&id,[recipeId+revisionNumber],recipeId", snapshots: "&id,recipeId,recipeRevisionId,createdAt", routes: "&id,name,updatedAt,archived,validationStatus", routeRevisions: "&id,[routeId+revisionNumber],routeId", recentCalculations: "&snapshotId,lastOpenedAt,recipeId", recovery: "&id", migrations: "&id", comparisons: "&id,name,updatedAt,validationStatus", layouts: "&id,name,kind,isDefault,builtIn,updatedAt", radiusDatasets: "&id,&[datasetId+datasetVersion],datasetId,datasetVersion,localTrust,updatedAt", recipeNotes: "&id,recipeId,recipeRevisionId,category,updatedAt,archived,*tags", userSettings: "&id,updatedAt", cloudSyncRecords: "&id,ownerId,[ownerId+cloudState],[ownerId+recordType],recordId,cloudId", cloudSyncSessions: "&ownerId,lastSuccessfulSyncAt", cloudConflicts: "&id,ownerId,[ownerId+status],[ownerId+recordType],recordId", cloudQuarantine: "&id,ownerId,[ownerId+recordType],receivedAt", cloudDevices: "&ownerId,installationId", cloudSyncOutbox: "&id,ownerId,[ownerId+state],[ownerId+recordType],recordId,nextAttemptAt,idempotencyKey", cloudSyncLeases: "&ownerId,installationId,tabId,expiresAt", labCaches: "&id,name,role,updatedAt", labMemberships: "&id,labId,userId,[labId+status],role", labEntries: "&id,labId,[labId+visibilityStatus],updatedAt,syncSequence", labVersions: "&id,labId,entryId,[entryId+versionNumber],syncSequence", labPublicationNotes: "&id,labId,entryId,publicationVersionId,syncSequence", labAuditEvents: "&id,labId,eventType,occurredAt,syncSequence", labSyncSessions: "&id,ownerId,labId,lastSuccessfulSyncAt", emiProjects: "&id,name,updatedAt,createdAt", xrdRawArtifacts: "&artifactId,&sha256,importedAt", xrdMeasurements: "&id,rawArtifactId,rawArtifactSha256,importedAt,displayName", xrdProcessedRepresentations: "&id,parentMeasurementId,rawArtifactSha256,createdAt", xrdPeakAnalyses: "&id,parentProcessedRepresentationId,parentMeasurementId,rawArtifactSha256,createdAt", xrdReferenceMatchingResults: "&id,parentPeakAnalysisId,parentProcessedRepresentationId,parentMeasurementId,referenceCifSha256,rawArtifactSha256,createdAt", xrdLatticeRefinementResults: "&id,parentMatchingResultId,parentPeakAnalysisId,parentMeasurementId,referenceCifSha256,rawArtifactSha256,createdAt",
    }).upgrade(async (transaction) => {
      await transaction.table("migrations").put({ schemaVersion: "15.0.0", id: "14-to-15-local-xrd-reference-analysis", fromVersion: 14, toVersion: 15, appliedAt: new Date().toISOString(), status: "complete" });
    });
    this.version(16).stores({
      recipes: "&id,name,targetFormula,updatedAt,archived,currentRevisionNumber,validationStatus", recipeRevisions: "&id,[recipeId+revisionNumber],recipeId", snapshots: "&id,recipeId,recipeRevisionId,createdAt", routes: "&id,name,updatedAt,archived,validationStatus", routeRevisions: "&id,[routeId+revisionNumber],routeId", recentCalculations: "&snapshotId,lastOpenedAt,recipeId", recovery: "&id", migrations: "&id", comparisons: "&id,name,updatedAt,validationStatus", layouts: "&id,name,kind,isDefault,builtIn,updatedAt", radiusDatasets: "&id,&[datasetId+datasetVersion],datasetId,datasetVersion,localTrust,updatedAt", recipeNotes: "&id,recipeId,recipeRevisionId,category,updatedAt,archived,*tags", userSettings: "&id,updatedAt", cloudSyncRecords: "&id,ownerId,[ownerId+cloudState],[ownerId+recordType],recordId,cloudId", cloudSyncSessions: "&ownerId,lastSuccessfulSyncAt", cloudConflicts: "&id,ownerId,[ownerId+status],[ownerId+recordType],recordId", cloudQuarantine: "&id,ownerId,[ownerId+recordType],receivedAt", cloudDevices: "&ownerId,installationId", cloudSyncOutbox: "&id,ownerId,[ownerId+state],[ownerId+recordType],recordId,nextAttemptAt,idempotencyKey", cloudSyncLeases: "&ownerId,installationId,tabId,expiresAt", labCaches: "&id,name,role,updatedAt", labMemberships: "&id,labId,userId,[labId+status],role", labEntries: "&id,labId,[labId+visibilityStatus],updatedAt,syncSequence", labVersions: "&id,labId,entryId,[entryId+versionNumber],syncSequence", labPublicationNotes: "&id,labId,entryId,publicationVersionId,syncSequence", labAuditEvents: "&id,labId,eventType,occurredAt,syncSequence", labSyncSessions: "&id,ownerId,labId,lastSuccessfulSyncAt", emiProjects: "&id,name,updatedAt,createdAt", xrdRawArtifacts: "&artifactId,&sha256,importedAt", xrdMeasurements: "&id,rawArtifactId,rawArtifactSha256,importedAt,displayName", xrdProcessedRepresentations: "&id,parentMeasurementId,rawArtifactSha256,createdAt", xrdPeakAnalyses: "&id,parentProcessedRepresentationId,parentMeasurementId,rawArtifactSha256,createdAt", xrdReferenceMatchingResults: "&id,parentPeakAnalysisId,parentProcessedRepresentationId,parentMeasurementId,referenceCifSha256,rawArtifactSha256,createdAt", xrdLatticeRefinementResults: "&id,parentMatchingResultId,parentPeakAnalysisId,parentMeasurementId,referenceCifSha256,rawArtifactSha256,createdAt", xrdReferences: "&referenceId,displayName,formula,sourceType,validationStatus,updatedAt,currentRevisionId,archived,*tags", xrdReferenceRevisions: "&revisionId,[referenceId+revisionNumber],referenceId,sourceType,validationStatus,cifSha256,createdAt",
    }).upgrade(async (transaction) => {
      await transaction.table("migrations").put({ schemaVersion: "16.0.0", id: "15-to-16-versioned-xrd-reference-library", fromVersion: 15, toVersion: 16, appliedAt: new Date().toISOString(), status: "complete" });
    });
  }
}
