...
export const SCIENTIFIC_REFERENCE_CASES: readonly ScientificReferenceCase[] = Object.freeze([
  ...
  reference("REF-008", "Elemental Al excess", "Ti2AlN", { adjustments: "5% Al elemental excess, pre-solver", expectedSolverQuantities: "Al requirement and elemental Al solution become 1.05 mol/mol target", expectedValueSource: "Hand-audited multiplication by 1.05", validationClass: "hand-audited" }),
