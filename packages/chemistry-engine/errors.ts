export type ChemistryErrorCode =
  ...
  | "SITE_RATIO_MODE_DISABLED"
  | "SITE_RATIO_LEADING_GROUP_REQUIRED"
  | "SITE_RATIO_NESTED_GROUP_UNSUPPORTED"
  | "SITE_RATIO_MULTIPLICITY_REQUIRED"
  | "SITE_RATIO_UNSUPPORTED_MULTIPLICITY"
  | "SITE_RATIO_TEMPLATE_MISMATCH"
  | "SITE_RATIO_MIXED_GROUP_REQUIRED"
  | "SITE_RATIO_ZERO_TOTAL"
  | "SITE_RATIO_INVALID_MAX_REMAINDER"
  | "MAX_X_COMPONENT_UNSUPPORTED"
  | "INVALID_COMPOSITION"
  | "INVALID_SCALAR"
  | "INVALID_TOLERANCE"
  | "EMPTY_COMPOSITION"
